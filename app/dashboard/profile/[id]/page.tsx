...
import { Loader2, UserPlus, UserCheck, Heart, MessageSquare, Globe, Calendar, MapPin, Grid, RefreshCw } from "lucide-react"
            ...
            <div className="flex items-center justify-center gap-3 pb-2">
              {session?.user?.id !== id && (
                <button 
                  ...
                  className={`flex items-center gap-2 px-8 py-2.5 rounded-full text-sm font-bold transition-all shadow-lg active:scale-95 ${
                    isFollowing 
                      ? "bg-bg-overlay border border-bg-border text-text-primary hover:bg-bg-border" 
